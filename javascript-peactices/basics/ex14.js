...
URL 다루기
*/
var url= 'http://www.mysite.com/user?name=둘리&no=10&email=bbc02131@naver.com';

//1. escape : URL 전부를 encoding, 사용(x), deprecated
var url2 = escape(url);
console.log(url2);

//2.encodeURI : URL 중 파라미터만 encoding하기 때문에 URL전체를 encoding 해야하는 경우, 사용(o)
...
//4.
//만들어야헐 URL
//http://www.mysite.com/user?name=둘리&no=10&email=bbc02131@naver.com
var url='http://www.mysite.com/user';
var formData={
    no:10,
    name: '둘리',
    email: 'bbc02131@naver.com'
}
